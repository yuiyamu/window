...
const DEFAULT_COLORS = {
  ActiveBorder:   rgbToHex(212,208,200),
  ActiveTitle:    rgbToHex( 10, 36,106),
  AppWorkspace:   rgbToHex(128,128,128),
  Background:     rgbToHex( 58,110,165),
  ButtonAlternateFace:   rgbToHex(192,192,192),
  ButtonDkShadow:   rgbToHex( 64, 64, 64),
  ButtonFace:     rgbToHex(212,208,200),
  ButtonHilight:  rgbToHex(255,255,255),
  ButtonLight:    rgbToHex(212,208,200),
  ButtonShadow:   rgbToHex(128,128,128),
  ButtonText:     rgbToHex(  0,  0,  0),
  GradientActiveTitle:   rgbToHex(166,202,240),
  GradientInactiveTitle: rgbToHex(192,192,192),
  GrayText:       rgbToHex(128,128,128),
  Hilight:        rgbToHex( 10, 36,106),
  HilightText:    rgbToHex(255,255,255),
  HotTrackingColor:      rgbToHex(  0,  0,128),
  InactiveBorder: rgbToHex(212,208,200),
  InactiveTitle:  rgbToHex(128,128,128),
  InactiveTitleText:     rgbToHex(212,208,200),
  InfoText:       rgbToHex(  0,  0,  0),
  InfoWindow:     rgbToHex(255,255,225),
  Menu:           rgbToHex(212,208,200),
  MenuBar:        rgbToHex(192,192,192),
  MenuHilight:    rgbToHex(  0,  0,128),
  MenuText:       rgbToHex(  0,  0,  0),
  Scrollbar:      rgbToHex(212,208,200),
  TitleText:      rgbToHex(255,255,255),
  Window:         rgbToHex(255,255,255),
  WindowFrame:    rgbToHex(  0,  0,  0),
  WindowText:     rgbToHex(  0,  0,  0),
};
...
function createWindowSVG({
  ...
  // The following string is the program's output and is not covered under the MPL-2.0.
  // The resulting output can be licensed under any terms of the user's choosing.
  const svg = `<!-- Generated by the Windows Classic Window Generator: https://tpenguinltg.github.io/winclassic-window/ -->
<svg
   width="${targetWidth}"
   height="${targetHeight}"
